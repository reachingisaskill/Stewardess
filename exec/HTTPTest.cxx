...
//
//    std::cout << "Creating test payload" << std::endl;
//    HTTPPayload* test_payload = new HTTPPayload( 42, ProtocolCommand::AuthorizeDeny );
//
//    std::cout << '\n' << test_payload->print() << '\n' << std::endl;
//
//    std::cout << "Serializing" << std::endl;
...
//
//    std::cout << "Creating test payload" << std::endl;
//    HTTPPayload* test_payload = new HTTPPayload( 9, ProtocolCommand::AuthorizeAccept );
//
//    std::cout << '\n' << test_payload->print() << '\n' << std::endl;
//
//    std::cout << "Serializing" << std::endl;
...
//
//    std::cout << "Creating test payload" << std::endl;
//    HTTPPayload* test_payload = new HTTPPayload( 0, ProtocolCommand::AuthorizeRequest );
